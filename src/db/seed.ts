...
const seedOptions: SeedOption[] = [
  ...
  { fieldSlug: "cake_style", name: "Carlota", priceCents: 0, sortOrder: 3, styleKind: "carlota" },
  { fieldSlug: "cake_style", name: "Torta Chilena", priceCents: 0, sortOrder: 4, styleKind: "torta_chilena" },
